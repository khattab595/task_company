...
class CustomListTile extends StatelessWidget {
  ...
  const CustomListTile({Key? key, required this.title, this.subtitle, this.iconLeading, this.trailing, this.onTap, this.isArrowForward = false, this.contentPadding, this.iconLeadingColor, this.titleStyle, this.iconLeadingSize}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: ListTile(
        ...
        leading: AppIcon(icon: iconLeading ?? AppIcons.clock, color: iconLeadingColor ?? theme.primaryColor, size: iconLeadingSize ?? 20),
